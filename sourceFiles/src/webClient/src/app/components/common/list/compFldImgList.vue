    ...
    <div>
      ...
      <div class="q-gutter-md row items-start">
          ...
          >
            ...
            <q-btn flat round size="sm" icon="delete" color="white" @click="showDeleteDialog(item.file)" class="absolute-bottom-right">
              <q-tooltip>Удалить фото</q-tooltip>
            </q-btn>
          </comp-stat-img-src>
        <q-btn flat round icon="add" size="sm" @click="isShowDialog = true">
          <q-tooltip>Добавить фото</q-tooltip>
        </q-btn>
        <q-btn v-if="ext && ext.canAddUrls" size="sm" flat round icon="add" @click="isShowDialogAddUrl = true">
