<template>
  <div>
    ...
    <p class="text-caption" v-if="notFound">не найдено</p>
...
<script>
            ...
            return {
                ...
                flds: [
                    ...
                    [
                        ...
                        {value: (v) => i18nStatus(v.state.status), label: 'Статус', class: 'col-xs-12 col-sm-6'},
                    ],
                  ]
            }
        },
    ...
    const i18nStatus = (v) => {
        switch (v) {
            ...
            case 'REORGANIZING': return 'в процессе присоединения к другому юрлицу';
            default: return v
        }
    }
</script>
