-- поиск пользователя по phone и паролю
-- параметры:
-- phone     type: string

DROP FUNCTION IF EXISTS user_get_by_phone_with_password(params JSONB);
CREATE OR REPLACE FUNCTION user_get_by_phone_with_password(params JSONB)
    RETURNS JSON
    LANGUAGE plpgsql
AS
$function$
