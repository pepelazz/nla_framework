	...
	p.I18n.Data = map[string]map[string]map[string]string{
		"ru": {
			"message": {
				...
				"files":                     "файлы",
				"photo":                     "фото",
				"dialog_delete_title":       "Подтвердите",
				...
				"only_files_with_extension": "допустимы только файлы с раширением",
				"only_files_no_larger_than": "допустимы только файлы не больше",
			},
			"auth": {
				"login":                             "войти",
				"password":                          "пароль",
		...
		"en": {
			"message": {
				...
				"add_photo":                 "add photo",
				"add_link":                  "add link",
				"only_files_with_extension": "only files with the extension",
				"only_files_no_larger_than": "only files no larger than",
			},
			"auth": {
				"login":                             "login",
				"password":                          "password",
